...
pub extern "C" fn unimplemented_sync(exception_class: u32) {
	...
	match exception_class {
		...
		10 => {
			kind = "Trapped execution of any instruction not covered by other EC values"
		}
		...
		51 => {
			kind =
				"Software step exception exception taken without a change in EL"
		}
		52 => kind = "Watchpoint exception from a lower EL",
		53 => {
			kind = "Watchpoint exception exception taken without a change in EL"
		}
